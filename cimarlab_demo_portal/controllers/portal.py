...
class CimarlabDemoPortalController(CustomerPortal):
    def _prepare_portal_layout_values(self):
        values = super(
            CimarlabDemoPortalController, self
        )._prepare_portal_layout_values()
        values["demo_model_2_portal_count"] = request.env[
            "demo.model_2.portal"
        ].search_count([])
        values["demo_model_3_portal_diagram_count"] = request.env[
    ...
    # ------------------------------------------------------------
    def _demo_model_2_portal_get_page_view_values(
        self, demo_model_2_portal, access_token, **kwargs
    ):
        values = {
    ...
    def portal_my_demo_model_2_portals(
        self,
        page=1,
        date_begin=None,
        date_end=None,
        ...
        **kw,
        ...
        return request.render(
            "cimarlab_demo_portal.portal_my_demo_model_2_portals", values
        )
    ...
    def portal_my_demo_model_2_portal(
        ...
        return request.render(
            "cimarlab_demo_portal.portal_my_demo_model_2_portal", values
        )

    # ------------------------------------------------------------
    # My Demo Model_3 Portal Diagram
    # ------------------------------------------------------------
    def _demo_model_3_portal_diagram_get_page_view_values(
        self, demo_model_3_portal_diagram, access_token, **kwargs
    ):
        values = {
            "page_name": "demo_model_3_portal_diagram",
            "demo_model_3_portal_diagram": demo_model_3_portal_diagram,
            "user": request.env.user,
        }
        return self._get_page_view_values(
            demo_model_3_portal_diagram,
            access_token,
            values,
    ...
    @http.route(
        [
            "/my/demo_model_3_portal_diagrams",
            "/my/demo_model_3_portal_diagrams/page/<int:page>",
        ],
        type="http",
        auth="user",
        website=True,
    )
    def portal_my_demo_model_3_portal_diagrams(
        self,
        page=1,
        date_begin=None,
        date_end=None,
        ...
        **kw,
        ...
        values = self._prepare_portal_layout_values()
        DemoModel3PortalDiagram = request.env["demo.model_3.portal.diagram"]
        domain = []
        ...
        # archive groups - Default Group By 'create_date'
        archive_groups = self._get_archive_groups(
            "demo.model_3.portal.diagram", domain
        )
        if date_begin and date_end:
            domain += [
                ("create_date", ">", date_begin),
        ...
        # demo_model_3_portal_diagrams count
        demo_model_3_portal_diagram_count = (
            DemoModel3PortalDiagram.search_count(domain)
        )
        # pager
        pager = portal_pager(
            url="/my/demo_model_3_portal_diagrams",
            url_args={
                "date_begin": date_begin,
                "date_end": date_end,
                "sortby": sortby,
            ...
            total=demo_model_3_portal_diagram_count,
            page=page,
            step=self._items_per_page,
        )

        # content according to pager and archive selected
        demo_model_3_portal_diagrams = DemoModel3PortalDiagram.search(
            domain,
            order=order,
            limit=self._items_per_page,
            offset=pager["offset"],
        ...
        values.update(
            {
                "date": date_begin,
                "date_end": date_end,
                "demo_model_3_portal_diagrams": demo_model_3_portal_diagrams,
                "page_name": "demo_model_3_portal_diagram",
                "archive_groups": archive_groups,
                "default_url": "/my/demo_model_3_portal_diagrams",
                "pager": pager,
                "searchbar_sortings": searchbar_sortings,
                "searchbar_groupby": searchbar_groupby,
                "searchbar_inputs": searchbar_inputs,
        ...
        return request.render(
            "cimarlab_demo_portal.portal_my_demo_model_3_portal_diagrams",
            values,
        )

    @http.route(
        [
            "/my/demo_model_3_portal_diagram/<int:demo_model_3_portal_diagram_id>"
        ],
        type="http",
        auth="public",
        website=True,
    )
    def portal_my_demo_model_3_portal_diagram(
        self, demo_model_3_portal_diagram_id=None, access_token=None, **kw
    ):
        try:
            demo_model_3_portal_diagram_sudo = self._document_check_access(
                "demo.model_3.portal.diagram",
        ...
        values = self._demo_model_3_portal_diagram_get_page_view_values(
            demo_model_3_portal_diagram_sudo, access_token, **kw
        )
        return request.render(
            "cimarlab_demo_portal.portal_my_demo_model_3_portal_diagram",
            values,
        )
    ...
    @http.route(
        ["/my/demo_model_portals", "/my/demo_model_portals/page/<int:page>"],
        type="http",
        auth="user",
        website=True,
    )
    def portal_my_demo_model_portals(
        self,
        page=1,
        date_begin=None,
        date_end=None,
        ...
        **kw,
        ...
        return request.render(
            "cimarlab_demo_portal.portal_my_demo_model_portals", values
        )
    ...
    def portal_my_demo_model_portal(
        ...
        return request.render(
            "cimarlab_demo_portal.portal_my_demo_model_portal", values
        )
