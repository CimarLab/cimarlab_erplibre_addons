...
class CimarlabDemoPortalController(http.Controller):
    @http.route(
        ["/cimarlab_demo_portal/helloworld"],
        type="json",
        auth="public",
        website=True,
        methods=["POST", "GET"],
    ...
    def create_new_demo_model_2_portal(self, **kw):
        ...
        return http.request.render(
            "cimarlab_demo_portal.portal_create_demo_model_2_portal",
            {
                "name": name,
    ...
    def create_new_demo_model_3_portal_diagram(self, **kw):
        name = http.request.env.user.name
        return http.request.render(
            "cimarlab_demo_portal.portal_create_demo_model_3_portal_diagram",
    ...
    def create_new_demo_model_portal(self, **kw):
        ...
        return http.request.render(
            "cimarlab_demo_portal.portal_create_demo_model_portal",
            {
                "name": name,
