odoo.define("register_snippet.animation", function (require) {
    "use strict";

    var sAnimation = require("website.content.snippets.animation");

    sAnimation.registry.register_snippet = sAnimation.Class.extend({
        selector: ".o_register_snippet",

        start: function () {
            var self = this;
            var def = this._rpc({ route: "/register_snippet/helloworld" }).then(
                function (data) {
                    if (data.error) {
                        return;
                    }
                    ...
                    self.$(".register_snippet_value").text(hello);
                }
            );
